...
public class CapitalOne {
    public static void main(String[] args) {
            ...
            scrumTeam1.hireTester(day42_CustomClass_Constructors.capitalOneTask.HumanResource.testersTeam1);
            scrumTeam1.hireDeveloper(day42_CustomClass_Constructors.capitalOneTask.HumanResource.devopsTeam1);

            ScrumTeam scrumTeam2 = new ScrumTeam("Selda", "Mucahit", "Dilem");
            scrumTeam2.hireTester(day42_CustomClass_Constructors.capitalOneTask.HumanResource.testersTeam2);
            scrumTeam2.hireDeveloper(day42_CustomClass_Constructors.capitalOneTask.HumanResource.devopsTeam2);

            ScrumTeam scrumTeam3 =new ScrumTeam("Mohigul","Maftuna","Zulkhumor");
            scrumTeam3.hireTester(day42_CustomClass_Constructors.capitalOneTask.HumanResource.testersTeam3);
